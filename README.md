...
How this works:
As the user, all you need to do is supply a business name and address through our map feature! Then, social media posts, review websites, and more are scraped for user reviews of the business. These reviews are put into a model finetuned on this type of data in order to provide a score for the company based on the sentiment of the reviews. The model also provides common positives and negatives found in the reviews.
